...
RSpec.describe Day_04 do
  ...
  it "test scratchcards_won_calculator with samples" do
    file_data = Day_04.read_input_file("spec/day_04/day_04_samples.txt")
    expect(Day_04.scratchcards_won_calculator(file_data)).to eq(30)
  end

  it "test scratchcards_won_calculator with final inputs" do
    file_data = Day_04.read_input_file("spec/day_04/day_04_input.txt")
    expect(Day_04.scratchcards_won_calculator(file_data)).to eq(6874754)
  end
end
